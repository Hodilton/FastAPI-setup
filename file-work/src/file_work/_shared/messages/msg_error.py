...
class MsgError(MsgBase):
    ...
    def file_read(cls, file_path: str, error: str) -> None:
        cls._logger.error(f"Read failed file './{file_path}': {error}")

    @classmethod
    def file_write(cls, file_path: str, error: str) -> None:
        cls._logger.error(f"Write failed file './{file_path}': {error}")
    ...
    def file_not_found(cls, file_path: str) -> None:
        cls._logger.error(f"Not found file './{file_path}'")

    @classmethod
    def file_exists(cls, file_path: str) -> None:
        cls._logger.error(f"Already exist file './{file_path}'")
